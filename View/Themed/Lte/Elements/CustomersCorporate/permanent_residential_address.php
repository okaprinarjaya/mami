<table class="table table-condensed table-striped form-custom-hack">
    ...
    <tr>
        <td class="hack-col-label">Address City Code</td>
        <td>
            <?php
    ...
    <tr>
        <td class="hack-col-label">Address Province Code</td>
        <td>
            <?php
            echo $this->Form->input('PROV_CODE', array(
                'type' => 'text',
                'div' => false,
                'label' => false,
                'class' => 'form-control input-sm'
    ...
    <tr>
        <td class="hack-col-label">Address Country Code</td>
        <td>
            <?php
            echo $this->Form->input('ADDR_CODE', array(
                'type' => 'text',
                'div' => false,
                'label' => false,
                'class' => 'form-control input-sm'
