<div class="box box-mami-green1">
    ...
    <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-user"></i> &nbsp; List Departments</h3>
    </div>
    ...
    <div class="box-body">
        ...
        <table id="pbs-index" class="table table-striped table-bordered">
            ...
            <tbody>
                <?php
                $page = $this->Paginator->params['paging']['Department']['page'];
                $limit = $this->Paginator->params['paging']['Department']['limit'];
